...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (restorePrefData()) {
        ...
        mList.add(new ScreenItem("ABOUT","Welcome to my application! \n Tugas Besar AKB 2019 (UAS)",R.drawable.gambar1));
        mList.add(new ScreenItem("FEATURE ","This application have 5 features i.e. Login, Register, Contact Menu, Profile Menu, and Friend Menu",R.drawable.gambar1));
        mList.add(new ScreenItem("READY","...",R.drawable.gambar1));
